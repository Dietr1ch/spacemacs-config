...
This function should only modify configuration layer settings."
	(setq-default
	 ...
	 ;;
	 ;; Configured in ./spacemacs/layers.el
	...
	(load-file (concat dotspacemacs-directory "spacemacs/layers.el"))
	)  ;; defun dotspacemacs/layers ()
...
It should only modify the values of Spacemacs settings."
	...
	(setq-default
	 ...
	 ;;
	 ;; See ~/Code/github/Dietr1ch/nixland/desktop/fonts.nix
	 ;; Should match Alacritty's ~/Code/github/Dietr1ch/nixland/desktop/terminal/alacritty.nix
	 ;;                          ~/.config/home-manager/home.nix
	 ;; Should be listed on fc-list | grep '.nix-profile/share/fonts/'
...
before packages are loaded."
	;; ./spacemacs/user-config.el
	(message "Loading user-config.el...")
...
;; LocalWords: LocalWords config dotspacemacs
